// AtivusHub PIX creation test - with all required fields
async function testFullPayload() {
    ...
    console.log('\n--- Testing Full Payload with ID: sementinha_test ---');
    const pixRes = await fetch(`${baseUrl}/v1/gateway/api/`, {
        ...
        body: JSON.stringify({
            ...
            customer: {
                ...
                cpf: '37803662800',
                phone: '11999999999',
                externaRef: `test_full_${Date.now()}`,
                address: {
                    street: 'Avenida Paulista',
                    streetNumber: '123',
                    complement: 'Apto 1', // Added
                    zipCode: '01310100',
            ...
            postbackUrl: 'https://agoraifoodbag.vercel.app/api/pix/webhook?gateway=ativushub', // Added
            pix: { expiresInDays: 2 }
        })
    });
...
testFullPayload().catch(console.error);
