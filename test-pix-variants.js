// AtivusHub PIX creation test - variant formats
async function testVariants() {
    ...
    const variants = [
        { name: 'String SellerID "86385022"', id_seller: "86385022" },
        { name: 'Sementinha Test Slug', id_seller: "sementinha_test" }
    ];
        ...
        const pixRes = await fetch(`${baseUrl}/v1/gateway/api/`, {
            ...
            body: JSON.stringify({
                ...
                customer: {
                    ...
                    cpf: '37803662800',
                    phone: '11999999999',
                    externaRef: `test_${v.id_seller}_${Date.now()}`,
                    address: {
