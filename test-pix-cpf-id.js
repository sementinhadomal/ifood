// AtivusHub PIX creation test - variant: seller document as ID
async function testSellerDoc() {
    ...
    const sellerCpf = "49936763874"; // From getCompany response

    console.log(`\n--- Testing with id_seller as CPF: ${sellerCpf} ---`);
    const pixRes = await fetch(`${baseUrl}/v1/gateway/api/`, {
        ...
        body: JSON.stringify({
            ...
            customer: {
                ...
                cpf: '37803662800',
                phone: '11999999999',
                externaRef: `test_cpf_id_${Date.now()}`,
                address: {
            ...
            items: [{ title: 'Frete Bag iFood', quantity: 1, unitPrice: 890, tangible: false }],
...
testSellerDoc().catch(console.error);
